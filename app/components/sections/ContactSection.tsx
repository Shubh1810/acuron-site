              ...
              <div className="lg:col-span-2 flex flex-col space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative z-10">
                    <span className="inline-block px-3 py-1 text-xs uppercase tracking-wider font-semibold bg-white/10 backdrop-blur-sm rounded-full mb-2 border-l-2 border-accent-400 text-white">{contactUsText}</span>
                    <h2 className="text-3xl md:text-4xl font-bold font-heading tracking-tight text-white/95 leading-tight mb-2">
                      {getInTouchText}
                      <span className="block text-lg md:text-xl text-accent-300 mt-2 font-normal">{hereToHelpText}</span>
                    </h2>
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-end">
                  <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 mb-4">
                    <div className="backdrop-blur-sm bg-white/5 rounded-2xl shadow-2xl border border-white/10 p-4 hover:bg-white/10 transition-colors duration-300">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="min-w-0">
                          <h3 className="text-white/90 font-semibold text-sm">{visitUsText}</h3>
                    ...
                    <div className="backdrop-blur-sm bg-white/5 rounded-2xl shadow-2xl border border-white/10 p-4 hover:bg-white/10 transition-colors duration-300">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="min-w-0">
                          <h3 className="text-white/90 font-semibold text-sm">{emailUsText}</h3>
                  ...
                  <div className="backdrop-blur-sm bg-white/5 rounded-2xl shadow-2xl border border-white/10 p-4 hover:bg-white/10 transition-colors duration-300">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="min-w-0">
                        <h3 className="text-white/90 font-semibold text-sm">{callUsText}</h3>
                  ...
                  <form className="space-y-5 flex-1 flex flex-col">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-gray-700">{fullNameText}</label>
                        <input 
                          type="text" 
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-gray-700">{organizationText}</label>
                        <input 
                          type="text" 
                          className="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 text-gray-900 placeholder-gray-400 text-sm transition-colors duration-200"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-gray-700">{emailText}</label>
                        <input 
                          type="email" 
                          className="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 text-gray-900 placeholder-gray-400 text-sm transition-colors duration-200"
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-gray-700">{phoneText}</label>
                        <input 
                          type="tel" 
                          className="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 text-gray-900 placeholder-gray-400 text-sm transition-colors duration-200"
                    ...
                    <div className="space-y-1.5">
                      <label className="block text-sm font-medium text-gray-700">{productInterestText}</label>
                      <select 
                    ...
                    <div className="space-y-1.5 flex-1">
                      <label className="block text-sm font-medium text-gray-700">{messageText}</label>
                      <textarea 
                        rows={4}
                    ...
                    <div className="mt-auto">
                      <div className="relative group">
                        ...
                        >
                          ...
                          <span className="relative">{sendInquiryText}</span>
                        </button>
                      </div>
                      <p className="text-xs text-gray-500 text-center mt-4">
                        {privacyText}{' '}
                        <Link href="/privacy" className="text-teal-600 hover:text-teal-700 transition-colors duration-200">{privacyPolicyText}</Link>
                      </p>
                    </div>
                  </form>
                </div>
