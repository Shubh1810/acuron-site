...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Reinforced surgeon gown with enhanced protection zones.",
    detailedDescription: "Reinforced surgeon gown designed for additional protection at critical zones. Available in multiple GSM options including eco and premium variants with towel.",
    category: "Protective Apparel",
    image: "/reinforced.webp",
    secondaryImage: "/reinforced.webp",
    featured: false,
    specs: ["Reinforced", "Multiple GSM options", "Optional Towel"],
    variants: [
      { productCode: "AP SGR4301", productName: "Reinforced Surgeon Gown 43 gsm Eco", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "62101000" },
      { productCode: "AP SGR50 01", productName: "Reinforced Surgeon Gown 50 gsm with Towel", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "62101000" }
    ],
    features: ["Reinforced critical zones", "Durable", "Comfortable fit"],
    applications: ["Surgical procedures", "Operating theatre"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "reinforced-surgeon-gown",
    metaTitle: "Reinforced Surgeon Gown | Acuron Products",
    metaDescription: "Reinforced surgeon gown available in 43 gsm eco and 50 gsm with towel variants for added protection.",
    keywords: ["reinforced gown", "surgeon gown", "AP SGR4301", "AP SGR50 01"]
  },
  {
    id: 102,
    name: "Patient Gowns",
  ...
  },
  {
    ...
    category: "Masks & Headwear",
    image: "/monkey-cap.webp",
    secondaryImage: "/monkey-cap.webp",
    featured: false,
  ...
  {
    id: 421,
    name: "Lamino Spinal Drape",
    description: "Spinal surgery drape designed for laminectomy procedures.",
    detailedDescription: "Lamino Spinal Drape engineered for spinal and laminectomy procedures with fluid control zones and adhesive fenestration for targeted access.",
    category: "Drapes, Linens & Underpads",
    image: "/lamino-spinal.webp",
    secondaryImage: "/lamino-spinal.webp",
    featured: false,
    specs: ["Procedure specific", "Adhesive fenestration", "Fluid control"],
    variants: [ { productCode: "AP DR LAM 01", productName: "Lamino Spinal Drape", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Targeted spinal access", "Barrier protection", "Integrated fluid control"],
    applications: ["Spinal surgery", "Laminectomy"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "lamino-spinal-drape",
    metaTitle: "Lamino Spinal Drape | Acuron Products",
    metaDescription: "Spinal surgery drape with adhesive fenestration and fluid control for laminectomy procedures.",
    keywords: ["spinal drape", "laminectomy drape", "lamino drape"]
  },
  {
    id: 422,
    name: "Universal Spine Drape",
    description: "Universal spine drape for a variety of spinal procedures.",
    detailedDescription: "Universal spine drape offering adaptable coverage for multiple spinal procedures with adhesive aperture and fluid collection areas.",
    category: "Drapes, Linens & Underpads",
    image: "/universal-spine.jpg",
    secondaryImage: "/universal-spine.jpg",
    featured: false,
    specs: ["Universal spinal coverage", "Adhesive aperture", "Fluid collection"],
    variants: [ { productCode: "AP DR USP 01", productName: "Universal Spine Drape", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Versatile design", "Barrier protection"],
    applications: ["Spinal procedures"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "universal-spine-drape",
    metaTitle: "Universal Spine Drape | Acuron Products",
    metaDescription: "Universal spine drape with adhesive aperture and fluid collection for various spinal procedures.",
    keywords: ["spine drape", "universal drape", "spinal procedures"]
  },
  {
    id: 423,
    name: "Craniotomy Drape",
    description: "Neurosurgical craniotomy drape with adhesive aperture.",
    detailedDescription: "Craniotomy drape designed for neurosurgical procedures with adhesive fenestration and fluid management areas for a clean field.",
    category: "Drapes, Linens & Underpads",
    image: "/craniotomy-drape.jpg",
    secondaryImage: "/craniotomy-drape.jpg",
    featured: false,
    specs: ["Adhesive fenestration", "Fluid control", "Procedure specific"],
    variants: [ { productCode: "AP DR CRA 01", productName: "Craniotomy Drape", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Precise surgical access", "Barrier protection"],
    applications: ["Craniotomy", "Neurosurgery"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "craniotomy-drape",
    metaTitle: "Craniotomy Drape | Acuron Products",
    metaDescription: "Craniotomy drape with adhesive fenestration and fluid control for neurosurgical procedures.",
    keywords: ["craniotomy drape", "neurosurgical drape"]
  },
  {
    id: 424,
    name: "Eye Drape Plain",
    description: "Plain ophthalmic drape for eye procedures.",
    detailedDescription: "Plain eye drape used for ophthalmic procedures, providing sterile coverage with a small fenestration as required.",
    category: "Drapes, Linens & Underpads",
    image: "/eye-drape.webp",
    secondaryImage: "/eye-drape.webp",
    featured: false,
    specs: ["Ophthalmic drape", "Plain", "Sterile"],
    variants: [ { productCode: "AP DR EYE 01", productName: "Eye Drape Plain", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Compact design", "Barrier protection"],
    applications: ["Ophthalmic procedures"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "eye-drape-plain",
    metaTitle: "Eye Drape Plain | Acuron Products",
    metaDescription: "Plain ophthalmic eye drape offering sterile coverage for eye procedures.",
    keywords: ["eye drape", "ophthalmic drape", "plain drape"]
  },
  {
    id: 425,
    name: "Cesarean Drape",
    description: "C-section surgical drape with adhesive incise.",
    detailedDescription: "Cesarean drape designed for C-section procedures with adhesive incise areas and fluid control zones for obstetric use.",
    category: "Drapes, Linens & Underpads",
    image: "/cesarean-drape.jpg",
    secondaryImage: "/cesarean-drape.jpg",
    featured: false,
    specs: ["Obstetric drape", "Adhesive incise", "Fluid control"],
    variants: [ { productCode: "AP DR CSD 01", productName: "Cesarean Drape", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Adhesive incise", "Integrated fluid collection"],
    applications: ["Cesarean section"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "cesarean-drape",
    metaTitle: "Cesarean Drape | Acuron Products",
    metaDescription: "Cesarean section drape with adhesive incise and fluid control for obstetric surgery.",
    keywords: ["cesarean drape", "c-section drape"]
  },
  {
    id: 426,
    name: "Full Gynac Drape / Normal Delivery Drape",
    description: "Full gynaecology drape for normal delivery procedures.",
    detailedDescription: "Full gynaecology drape providing comprehensive coverage for normal delivery with fluid collection areas.",
    category: "Drapes, Linens & Underpads",
    image: "/full-gynac.jpeg",
    secondaryImage: "/full-gynac.jpeg",
    featured: false,
    specs: ["Full coverage", "Obstetric use", "Fluid collection"],
    variants: [ { productCode: "AP DR GYN 01", productName: "Full Gynac / Normal Delivery Drape", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Comprehensive coverage", "Barrier protection"],
    applications: ["Normal delivery", "Obstetric procedures"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "full-gynac-normal-delivery-drape",
    metaTitle: "Full Gynac Drape / Normal Delivery Drape | Acuron Products",
    metaDescription: "Full gynaecology drape for normal delivery with fluid collection and comprehensive coverage.",
    keywords: ["gynac drape", "normal delivery drape", "obstetric drape"]
  },
  {
    id: 427,
    name: "Neonatal Sheet",
    description: "Sterile neonatal sheet for infant care.",
    detailedDescription: "Soft, sterile neonatal sheet designed for infant procedures and care, providing hygienic coverage.",
    category: "Drapes, Linens & Underpads",
    image: "/C-section.jpg",
    secondaryImage: "/C-section.jpg",
    featured: false,
    specs: ["Soft material", "Hygienic", "Sterile"],
    variants: [ { productCode: "AP DR NEO 01", productName: "Neonatal Sheet", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63041940" } ],
    features: ["Gentle on skin", "Hygienic coverage"],
    applications: ["Neonatal care", "Infant procedures"],
    certifications: ["ISO 13485"],
    slug: "neonatal-sheet",
    metaTitle: "Neonatal Sheet | Acuron Products",
    metaDescription: "Sterile neonatal sheet providing hygienic coverage for infant care and procedures.",
    keywords: ["neonatal sheet", "infant sheet"]
  },
  {
    id: 428,
    name: "Cesarean Drape with Attached Drain Funnel",
    description: "C-section drape with integrated drain funnel.",
    detailedDescription: "Cesarean drape featuring an attached drain funnel for efficient fluid management during obstetric procedures.",
    category: "Drapes, Linens & Underpads",
    image: "/C-section.jpg",
    secondaryImage: "/C-section.jpg",
    featured: false,
    specs: ["Attached drain funnel", "Adhesive incise", "Fluid control"],
    variants: [ { productCode: "AP DR CSF 01", productName: "Cesarean Drape with Attached Drain Funnel", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Integrated drainage", "Barrier protection"],
    applications: ["Cesarean section"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "cesarean-drape-attached-drain-funnel",
    metaTitle: "Cesarean Drape with Attached Drain Funnel | Acuron Products",
    metaDescription: "C-section drape with attached drain funnel for effective fluid management during obstetric surgery.",
    keywords: ["cesarean drape", "drain funnel drape", "c-section drape"]
  },
  {
    id: 429,
    name: "C Section Drape with Drainage Bag",
    description: "C-section drape with integrated drainage bag.",
    detailedDescription: "C Section drape designed with an integrated drainage bag to collect fluids efficiently during cesarean procedures.",
    category: "Drapes, Linens & Underpads",
    image: "/C-section.jpg",
    secondaryImage: "/C-section.jpg",
    featured: false,
    specs: ["Integrated drainage bag", "Adhesive incise", "Fluid control"],
    variants: [ { productCode: "AP DR CSD B01", productName: "C Section Drape with Drainage Bag", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Integrated bag", "Barrier protection"],
    applications: ["Cesarean section"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "c-section-drape-with-drainage-bag",
    metaTitle: "C Section Drape with Drainage Bag | Acuron Products",
    metaDescription: "C-section drape with integrated drainage bag for efficient fluid collection during obstetric surgery.",
    keywords: ["c-section drape", "drainage bag drape", "obstetric drape"]
  },
  {
    id: 430,
    name: "Under Buttock Drape",
    description: "Under buttock drape for obstetric and gynaecological procedures.",
    detailedDescription: "Under buttock drape designed for obstetric and gynaecological procedures with fluid collection pouch.",
    category: "Drapes, Linens & Underpads",
    image: "/underbottock.jpg",
    secondaryImage: "/underbottock.jpg",
    featured: false,
    specs: ["Fluid collection pouch", "Obstetric use", "Barrier protection"],
    variants: [ { productCode: "AP DR UBD 01", productName: "Under Buttock Drape", packingPerBox: "Ind. Pack", gstPercentage: "5.00%", hsnCode: "63079090" } ],
    features: ["Integrated pouch", "Hygienic coverage"],
    applications: ["Obstetric procedures", "Gynaecology"],
    certifications: ["ISO 13485", "CE Mark"],
    slug: "under-buttock-drape",
    metaTitle: "Under Buttock Drape | Acuron Products",
    metaDescription: "Under buttock drape with fluid collection pouch for obstetric and gynaecological procedures.",
    keywords: ["under buttock drape", "obstetric drape", "gynaecology drape"]
  },
  {
    id: 4030,
